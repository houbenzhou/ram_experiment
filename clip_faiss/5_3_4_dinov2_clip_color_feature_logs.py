...
def image_search(image, k=1):
    ...
    image_features_color = get_image_color_features(image)
    image_features_clip = get_image_clip_features(image)
    image_features_dinov2 = get_dinov2_features(image)
...
if __name__ == "__main__":
    ...
    faiss_path = os.path.join(base_path,"output","faiss_model","dinov2_clip_color_feature","35_category_05_normalized")
