...
if __name__ == "__main__":
    ...
    # image_path = os.path.join(base_path, 'data', '新零售图片数据_Trax_部分','(复)特慧优沙琪玛(黑糖味)450g','1674955364653_2_2306.0_1277.0_656.0_672.0_0.0.jpg')
    image_path = os.path.join(base_path, 'data', 'cat.jpg')
    ...
    if id_type == 'category_name':
        out_path = os.path.join(base_path, 'output', 'faiss_model', 'color_feature','35_category')
